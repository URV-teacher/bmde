...
from bmde.core.shared_options import ArgumentsOpt, DirectoryOpt, BackendOpt, EntrypointOpt, DryRunOpt, SshUsernameOpt, \
    SshPasswordOpt, SshHostOpt, GitNameOpt, GitEmailOpt, VpnUsernameOpt, VpnPasswordOpt, VpnHostOpt, VpnPortOpt, \
    VpnRealmOpt, VpnCertOpt, VpnTestDnsOpt, VpnTestIpOpt
